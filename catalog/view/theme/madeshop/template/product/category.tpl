    ...
    <div class="row">
      ...
      <div class="sort-block">
        <div id="cat-select" class="w-select hidden">
		  ...
		  <option value="" selected="selected"><?php echo $heading_title; ?></option>
	    ...
	    <div class="btn-group hidden-xs pull-right hidden">
          <button type="button" id="list-view" class="no-btn rad-btn" title="<?php echo $button_list; ?>"><i class="fa fa-th-list"></i></button>
          <button type="button" id="grid-view" class="no-btn rad-btn" title="<?php echo $button_grid; ?>"><i class="fa fa-th"></i></button>
        </div>
      </div>
      </div>
    </div>
