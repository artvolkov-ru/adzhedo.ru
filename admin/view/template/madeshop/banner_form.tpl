              ...
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    <td class="text-left">
					<input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][pretitle]" value="<?php echo $banner_image['pretitle']; ?>" placeholder="<?php echo $entry_pretitle; ?>" class="form-control" />
                  ...
                  <?php } ?>
					<input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][destitle]" value="<?php echo $banner_image['destitle']; ?>" placeholder="<?php echo $entry_destitle; ?>" class="form-control" />  					  
					  <div class="bgpicker<?php echo $image_row; ?>">
                        <input name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][color]" type="text" value="<?php echo $banner_image['color']; ?>" class="form-control bgpicker">
                        <span class="delcolor" onclick="delcolor('<?php echo $image_row; ?>');">x</span>
                      </div>  
					  </td>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
					<input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][width]" value="<?php echo $banner_image['width']; ?>" placeholder="ширина" class="form-control" />
					<input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][height]" value="<?php echo $banner_image['height']; ?>" placeholder="высота" class="form-control" />
                  </div>
                </div>
					  </td>
...
function addImage(language_id) {
    ...
    html += '  <td class="text-left"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][pretitle]" value="" placeholder="<?php echo $entry_pretitle; ?>" class="form-control" />';
    html += '<input type="text" name="banner_image[' + language_id + '][' + image_row + '][title]" value="" placeholder="<?php echo $entry_title; ?>" class="form-control" />';
    html += '<input type="text" name="banner_image[' + language_id + '][' + image_row + '][destitle]" value="" placeholder="<?php echo $entry_destitle; ?>" class="form-control" /><div class="bgpicker' + image_row + '"><input name="banner_image[' + language_id + '][' + image_row + '][color]" type="text" value="" class="form-control bgpicker"><span class="delcolor" onclick="delcolor(' + image_row + ');">x</span></div></td>';	
	...
	html += '  <td class="text-center"><a href="" id="thumb-image' + image_row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="banner_image[' + language_id + '][' + image_row + '][image]" value="" id="input-image' + image_row + '" />';
	html += '<div class="form-group">';
    html += '              <label class="col-sm-2 control-label">Размеры</label>';
    html += '              <div class="col-sm-10">';
	html += '				<input type="text" name="banner_image[' + language_id + '][' + image_row + '][width]" value="" placeholder="ширина" class="form-control" />';
	html += '				<input type="text" name="banner_image[' + language_id + '][' + image_row + '][height]" value="" placeholder="высота" class="form-control" />';
    html += '              </div>';
    html += '           </div>';
	html += '</td>';
...
function bgpicker() {	
$(function(){	
  var colpick = $('.bgpicker').each( function() {
    $(this).minicolors({
...
$('.bgpicker').each(function(index) {
	bgpicker(index);
});	
	

function delcolor(sec) {
$('.bgpicker'+sec+' input').val("");
$('.bgpicker'+sec+' .minicolors-swatch-color').css('background-color', '');
