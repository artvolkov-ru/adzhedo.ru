...
<div id="content">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-css" class="form-horizontal">
          ...
          <fieldset>
            <legend><?php echo $entry_css; ?></legend>
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-css"><?php echo $entry_css; ?></label>
              <div class="col-sm-10">
                <textarea name="css_content" placeholder="" id="input-css" class="form-control"><?php echo $css_content; ?></textarea>
 ...
 <div class="form-group">
              ...
              <div class="col-sm-10">
                <select name="css_status" id="input-status" class="form-control">
                  <?php if ($css_status) { ?>
...
<?php echo $footer; ?>
 <script>
      var editor = CodeMirror.fromTextArea(document.getElementById("input-css"), {
